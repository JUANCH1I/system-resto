import { getP12FromLocalFile } from 'rsbmk-open-factura'
import {
...
const signature = await getP12FromLocalFile(
  'src/sri/certificados/1013252787118662625022153733.p12'
)
const password = '@Manfre2024'
